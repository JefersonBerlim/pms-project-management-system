    ...
    public void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException, RollbackFailureException, Exception {
        try {
            ...
            for (TbMateriais tbMateriais : tbMateriaisCollection) {
                ...
                illegalOrphanMessages.add("A Unidade de Medida (" + tbUnidadeMedida.getDescricao()
                        + ") não pode ser excluído pois esta vinculado no Material "
                        + tbMateriais.getDescricao() + ".");
            }
