...
CREATE SEQUENCE GEN_TB_MATERIAL_MARCO_SVC;
...
CREATE SEQUENCE GEN_TB_OS_MATERIAIS_TOTAL;
CREATE SEQUENCE GEN_TB_OS_RECURSOS_TOTAL;
CREATE SEQUENCE GEN_TB_OS_FUNCIONARIOS_TOTAL;
...
/*TB_OS_MATERIAIS_TOTAL*/
SET TERM ^ ;

CREATE TRIGGER INSERT_TB_OS_MATERIAIS_TOTAL FOR TB_OS_MATERIAIS_TOTAL
ACTIVE BEFORE INSERT POSITION 0
AS
BEGIN
  IF (NEW.HAND IS NULL) THEN
    NEW.HAND = GEN_ID(GEN_TB_OS_MATERIAIS_TOTAL,1);
END
^
...
/*TB_OS_RECURSOS_TOTAL*/
SET TERM ^ ;

CREATE TRIGGER INSERT_TB_OS_RECURSOS_TOTAL FOR TB_OS_RECURSOS_TOTAL
ACTIVE BEFORE INSERT POSITION 0
AS
BEGIN
  IF (NEW.HAND IS NULL) THEN
    NEW.HAND = GEN_ID(GEN_TB_OS_RECURSOS_TOTAL,1);
END
^
...
/*TB_OS_FUNCIONARIOS_TOTAL*/
SET TERM ^ ;

CREATE TRIGGER INSERT_TB_OS_FUNCIONARIOS_TOTAL FOR TB_OS_FUNCIONARIOS_TOTAL
ACTIVE BEFORE INSERT POSITION 0
AS
BEGIN
  IF (NEW.HAND IS NULL) THEN
    NEW.HAND = GEN_ID(GEN_TB_OS_FUNCIONARIOS_TOTAL,1);
END
^
...
/*TB_MATERIAL_MARCO_SVC*/
SET TERM ^ ;

CREATE TRIGGER INSERT_TB_MATERIAL_MARCO_SVC FOR TB_MATERIAL_MARCO_SVC
ACTIVE BEFORE INSERT POSITION 0
AS
BEGIN
  IF (NEW.HAND IS NULL) THEN
    NEW.HAND = GEN_ID(GEN_TB_MATERIAL_MARCO_SVC,1);
END
^
